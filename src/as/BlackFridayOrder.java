...
// trieda pre vytvorenie BF objednavky
public class BlackFridayOrder implements Order {
    ...
    public BlackFridayOrder(Customer customer) {
        this.customer = customer;
        this.products = new ArrayList<>();
        this.totalPrice = 0.0;
        this.discountStrategy = new BlackFridayDiscountStrategy(); // BF strategia
    }
